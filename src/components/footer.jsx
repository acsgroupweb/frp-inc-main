...
export default function Footer() {
  ...
  return (
    ...
    showfooter ? (
      ...
      <footer className="" style={{display:'flex', flexDirection:'column', padding:'', marginTop:'0', position:'relative', width:'100vw',textAlign:'center'}}>
...
{/* 
   ...
   */}
        ...
        <span>3535 East 96th Street, Suite 126</span>
      ...
      <div style={{width:'100%', textAlign: 'center', margin: '1rem 10px 1rem 10px', justifyContent: 'center', fontSize: '.95rem', textDecoration:'none'}}>
