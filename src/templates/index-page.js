...
{/* show feature */}
{showFeature ? (   
<section id="features" order="1" name="feature" className="print scroll-area1" style={{ display:'', top:'0', height:'auto', maxHeight:'', margin:'0 0 0 0', padding:'0 0 10px 0', position:'relative', background:'var(--theme-ui-colors-background)'}}>
...
Founded in 1944 and located in Indianapolis, Indiana, FRP has consistently been involved in significant structural engineering and architectural projects.
  ...
  <img src="/assets/Slider1.webp" alt="slide 1" style={{margin:'0 auto'}} />
  <img src="/assets/Slider2.webp" alt="slide 2" style={{margin:'0 auto'}} />
...
{/* show posts */}
{showPosts ? (
  <section id="showPosts" order="3" className="scroll-area" style={{display:'block', height:'',  minHeight:'', position:'relative', zIndex:'0', overflow:'visible', margin:'0 auto 0 auto', padding:'0 0 0 0', border:'0px solid blue', background:'var(--theme-ui-colors-background)'}}>
...
<section className="print scroll-area" id="Team" order="5" style={{ width:'100%', overflow:'hidden', position:'relative', justifyContent:'center', alignContent:'center', margin:'0 auto', textAlign:'center', borderRadius:'8px', minHeight:'70vh', maxWidth:'', padding:'1rem', display:'', placeContent:'',  }}>

<StaticImage src="../../static/assets/frpinc-logo-notext.webp" alt="Default Image" style={{height:'auto', maxHeight:'100vh', position:'relative', zIndex:'0', top:'0',border:'0px solid !important', objectFit:'contain', margin:'0 auto'}} />
...
<div className="nameblock flexcheek" style={{position:'sticky', top:'0', marginTop: '', width:'100%', maxWidth:'70vw', margin:'0 auto', padding: '2vw 3vh', maxHeight: '', fontSize: 'clamp(1rem, 1.4vw, 3.2rem)', textShadow: '0 2px 3px #000', color: '#fff', background: 'rgba(0,0,0,0.50)', backdropFilter: 'blur(12px)', borderRadius: '10px', textWrap: 'balance', lineHeight:'250%', }}>
...
<div><Link to="/team" className="button" style={{}}>Meet Our Team</Link></div>
</section>
